...
<head>
    ...
    <link rel="stylesheet" href="css/AllInformation.css">
...
<div class="font">
    <div class="col-md-12 bottom-top">
        <h4 class="title"><span><strong>今日已回访信息</strong></span></h4>
    </div>
    <table border="1" style="padding: 0px;border-collapse:collapse;background-color: #F6F6F6;" class="title">
        <thead>
        <tr style="height: 45px;" align="left">
            <th width="50">编号</th>
            <th >学生姓名</th>
            <th width="40">性别</th>
            <th width="100">分配时间</th>
            <th width="100">预约上门</th>
            <th width="100">下次回访</th>
