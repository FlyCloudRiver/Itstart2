...
<div id="container-fluid">
    ...
    <div id="wy_footer" class="row">
        <div class="col-sm-10">
            <span id="wy_title_header2" style="font-size: 20px">正式课列表</span>
        </div>
        <div class="col-sm-2">
            <input type="button" class="btn btn-info" data-toggle="modal"  data-target='#addWyModal'  value="新增正式课" onclick="openAddModalExperience()" >
        </div>
    ...
    <script src="${pageContext.request.contextPath}/statics/js/formalClasses.js"/>
</body>
</html>
